...
\begin{figure}[htbp]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{../data/compare-benchmark-submission.png} &
    \includegraphics[width=0.45\textwidth]{../data/compare-qf-lia.png} \\
    (a) Compare solvers on Certora Benchmarks &
    (b) Compare solvers on QF-LIA \\
    \multicolumn{2}{c}{
      \includegraphics[width=0.45\textwidth]{../data/compare-qf-nia.png}
    } \\
    \multicolumn{2}{c}{
      (c) Compare solvers on QF-NIA
    } \\
  \end{tabular}
