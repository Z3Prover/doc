...
(declare-fun dz () Int)
(declare-fun rz () Bool)
(assert (let ((?v_0 (not P_3)) (?v_3 (not P_9))) (let ((?v_2 (not (ite ?v_0 false (ite (not P_4) (or (or P_5 P_6) P_7) false)))) (?v_1 (not (not P_2))) (?v_5 (not P_31)) (?v_4 (not P_30))) (let ((?v_7 (ite ?v_4 0 (ite ?v_5 P_32 P_33))) (?v_6 (not (not P_29)))) (let ((?v_10 (ite ?v_6 ?v_7 (ite ?v_4 0 (ite ?v_5 P_33 P_34)))) (?v_8 (ite (not (not P_35)) ?v_7 (ite ?v_4 0 (ite ?v_5 P_36 P_37)))) (?v_9 (not (not P_41)))) (let ((?v_11 (ite ?v_9 ?v_7 (ite ?v_4 0 (ite ?v_5 P_42 P_32)))) (?v_12 (ite (not (not P_45)) ?v_7 (ite ?v_4 0 (ite ?v_5 P_46 P_47))))) (let ((?v_14 (= (+ (ite (> (ite (not (not P_28)) ?v_10 (ite ?v_6 ?v_8 (ite ?v_4 0 (ite ?v_5 P_37 P_38)))) P_39) 256 0) (+ (ite (> ?v_8 P_39) 128 0) (+ (ite (> (ite (not (not P_40)) ?v_11 (ite ?v_9 ?v_8 (ite ?v_4 0 (ite ?v_5 P_43 P_36)))) P_39) 64 0) (+ (ite (> ?v_10 P_39) 32 0) (+ (ite (> ?v_7 P_39) 16 0) (+ (ite (> ?v_11 P_39) 8 0) (+ (ite (> (ite (not (not P_44)) ?v_10 (ite ?v_6 ?v_12 (ite ?v_4 0 (ite ?v_5 P_47 P_48)))) P_39) 4 0) (+ (ite (> ?v_12 P_39) 2 0) (ite (> (ite (not (not P_49)) ?v_11 (ite ?v_9 ?v_12 (ite ?v_4 0 (ite ?v_5 P_50 P_46)))) P_39) 1 0))))))))) 92)) (?v_13 (not (not (or (not (ite ?v_1 (ite ?v_2 (ite ?v_0 P_8 (ite ?v_3 P_10 P_8)) P_8) false)) (not (ite ?v_1 (ite ?v_2 (ite ?v_0 P_11 (ite ?v_3 (not (= (ite (not (not P_12)) 0 (+ (+ (+ (+ (+ (+ (+ (+ (ite (and (and P_13 P_14) (< (ite (< P_15 4) P_15 (- P_15 8)) 0)) 1 0) (ite (and P_13 (< P_16 0)) 1 0)) (ite (and (and P_13 P_17) P_18) 1 0)) (ite (and P_14 (< (ite (< P_19 4) P_19 (- P_19 8)) 0)) 1 0)) (ite (< P_20 0) 1 0)) (ite (and P_17 P_21) 1 0)) (ite (and (and P_22 P_14) (< (ite (< P_23 4) P_23 (- P_23 8)) 0)) 1 0)) (ite (and P_22 (< P_24 0)) 1 0)) (ite (and (and P_22 P_17) P_25) 1 0))) 0)) P_11)) P_11) false)))))) (?v_16 (ite (not (not (or (not P_8) (not P_11)))) P_26 P_27)) (?v_15 (ite (not (not (or (not P_10) P_12))) P_51 P_52))) (= (+ (* 2 dz) 1) (- (ite (ite ?v_13 false (ite ?v_1 (ite ?v_2 (ite ?v_0 P_27 (ite ?v_3 (and ?v_14 (< (ite (< P_52 128) P_52 (- P_52 256)) 0)) P_27)) P_27) false)) 1 0) (ite (ite ?v_13 false (ite ?v_1 (ite ?v_2 (ite ?v_0 ?v_16 (ite ?v_3 (and ?v_14 (< (ite (< ?v_15 128) ?v_15 (- ?v_15 256)) 0)) ?v_16)) ?v_16) false)) 1 0))))))))))
(check-sat)
(exit)
