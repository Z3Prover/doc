...
(assert (>= x3_plus 0))
(assert (>= x3_minus 0))
(assert (<= (+ x8_plus (* (- 1) x8_minus) x7_plus (* (- 1) x7_minus) (* (- 1) x5_plus) x5_minus x2_plus (* (- 1) x2_minus) (* (- 1) x0_plus) x0_minus ) (- 1) ) )
(assert (<= (+ x9_plus (* (- 1) x9_minus) (* (- 1) x4_plus) x4_minus (* (- 1) x2_plus) x2_minus x1_plus (* (- 1) x1_minus) ) 1 ) )
(assert (<= (+ x9_plus (* (- 1) x9_minus) (* (- 1) x8_plus) x8_minus x5_plus (* (- 1) x5_minus) (* (- 1) x0_plus) x0_minus ) 0 ) )
(assert (<= (+ (* 2 x9_plus) (* (- 2) x9_minus) x5_plus (* (- 1) x5_minus) x1_plus (* (- 1) x1_minus) ) 1 ) )
(assert (<= (+ x3_plus (* (- 1) x3_minus) x1_plus (* (- 1) x1_minus) (* (- 1) x0_plus) x0_minus ) (- 1) ) )
(assert (<= (+ x9_plus (* (- 1) x9_minus) x8_plus (* (- 1) x8_minus) x4_plus (* (- 1) x4_minus) ) 1 ) )
(assert (<= (+ x9_plus (* (- 1) x9_minus) (* 2 x8_plus) (* (- 2) x8_minus) ) 1 ) )
(assert (>= (+ x5_plus (* (- 1) x5_minus) (* (- 1) x4_plus) x4_minus x3_plus (* (- 1) x3_minus) x2_plus (* (- 1) x2_minus) ) 0 ) )
(assert (>= (+ x8_plus (* (- 1) x8_minus) (* (- 1) x5_plus) x5_minus (* (- 2) x2_plus) (* 2 x2_minus) ) 0 ) )
(assert (>= (+ x8_plus (* (- 1) x8_minus) (* (- 2) x5_plus) (* 2 x5_minus) x3_plus (* (- 1) x3_minus) ) (- 1) ) )
(check-sat)
(exit)
