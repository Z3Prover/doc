...
(assert (<= (+ x9_plus (* (- 1) x9_minus) (* (- 1) x7_plus) x7_minus x5_plus (* (- 1) x5_minus) x4_plus (* (- 1) x4_minus) (* (- 1) x0_plus) x0_minus ) (- 1) ) )
(assert (<= (+ x9_plus (* (- 1) x9_minus) (* (- 1) x5_plus) x5_minus (* (- 2) x0_plus) (* 2 x0_minus) ) 1 ) )
(assert (<= (+ x8_plus (* (- 1) x8_minus) (* (- 1) x4_plus) x4_minus x0_plus (* (- 1) x0_minus) ) 0 ) )
